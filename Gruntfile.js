  ...
  grunt.initConfig({
		...
		concat: {
            JS : {
                ...
                src: ['src/js/Head.html','src/js/Contents.html','src/js/Intro.html','src/js/CloudApp.html','src/js/CloudObject.html','src/js/Relationships.html','src/js/CloudQuery.html','src/js/CloudNotification.html','src/js/CloudSearch.html','src/js/CloudGeoPoint.html','src/js/CloudUser.html','src/js/CloudRole.html','src/js/CloudFile.html','src/js/Column.html','src/js/CloudTable.html', 'src/js/ACL.html','src/js/JSON.html','src/js/Contribute.html','src/js/Footer.html'],
